...
| v1.7.0 | Architecture evolution — plugins boundary / parallel race / content quality / step ResourceRef contracts / DAG analysis |

`CONTRACT_VERSION` (current): `(1, 4, 0)` (bumped in v1.7.0 — M4 StepSpec contract fields; was (1, 3, 0) through v1.6.0)
