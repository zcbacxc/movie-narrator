...
> **Compatibility note.** This document describes version **1.3.2** governance. The engine is at **1.3.2** with `CONTRACT_VERSION=(1,2,0)`. Run `mn version` to check your installed build.
