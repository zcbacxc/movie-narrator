...
> **Compatibility note.** This document describes version **1.7.0** governance. The engine is at **1.7.0** with `CONTRACT_VERSION=(1,4,0)`. Run `mn version` to check your installed build.
