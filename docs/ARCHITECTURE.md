...
- Strict env/yaml boundary: `.env` (Settings) = 24 LLM + TTS infrastructure fields only; `job.yaml` (params) = 52 pipeline behavior keys; no code constants module — inline literals match example files
