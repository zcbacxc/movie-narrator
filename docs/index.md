...
- [Quickstart](QUICKSTART.md) — build your first plugin in under 10 minutes
- [Tutorial](TUTORIAL.md) — from-zero-to-advanced usage walkthrough
- [Plugin Development](PLUGIN_DEVELOPMENT.md) — full Plugin SDK reference
- [Architecture](ARCHITECTURE.md) — system design and component relationships
- [Architecture Decision Records](ADR.md) — key design decisions
...
- [Release Checklist](RELEASE_CHECKLIST.md) — v1.6.0 Definition of Done (historical); current package **1.7.0** / contract **1.4.0** — see CHANGELOG
